...
//CODE HERE- THIS IS NOT WORKING WHAT THE HECK
...
let empOne = new Employee ("Jess", "weekday morings, weekday afternoons");
//console.log(empOne)
...
class Manager extends Employee {
    ...
    getEmployees() {
        return(`${this.name} manages ${this.employees}`);  //is this return??
    }
    addEmployee(emp) {
...
let manager = new Manager("Winston", "weekday mornings, weekday afternoons", ["CeeCee", "Schmidt"])
